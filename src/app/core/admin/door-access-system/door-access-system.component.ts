...
@Component({
  selector: "app-door-access-system",
  templateUrl: "./door-access-system.component.html",
  styleUrls: ["./door-access-system.component.scss"]
})
export class DoorAccessSystemComponent implements OnInit {
  ...
  initChartOne() {
    ...
    chart.data = [
      {
        das: "DASKAJANG1",
        totalneedmaintenance: 13,
        totalinstall: 20
      },
      {
        das: "DASPENANG3",
        totalneedmaintenance: 11,
        totalinstall: 25
      },
      {
        das: "DASIPOH3",
        totalneedmaintenance: 7,
        totalinstall: 20
      },
      {
        das: "DASRAWANG10",
        totalneedmaintenance: 8,
        totalinstall: 15
      },
      {
        das: "DASSEREMBAN5",
        totalneedmaintenance: 18,
        totalinstall: 25
      }
    ];
    ...
    categoryAxis.dataFields.category = "das";
    ...
    function createSeries(field, name) {
      ...
      series.dataFields.categoryY = "das";
      series.stacked = true;
      series.name = name;
    ...
    createSeries("totalneedmaintenance", "Total Need Maintenance");
    createSeries("totalinstall", "Total Install");
  }

  initChartTwo() {
    let chart = am4core.create("chartdivtwo", am4charts.RadarChart);
