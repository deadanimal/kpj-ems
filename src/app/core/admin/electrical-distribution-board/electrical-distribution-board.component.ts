...
@Component({
  selector: "app-electrical-distribution-board",
  templateUrl: "./electrical-distribution-board.component.html",
  styleUrls: ["./electrical-distribution-board.component.scss"]
})
export class ElectricalDistributionBoardComponent implements OnInit {
