...
@Component({
  selector: "app-fire-panel",
  templateUrl: "./fire-panel.component.html",
  styleUrls: ["./fire-panel.component.scss"]
})
export class FirePanelComponent implements OnInit {
  ...
  initChartOne() {
    let chart = am4core.create("chartdivone", am4charts.PieChart3D);
