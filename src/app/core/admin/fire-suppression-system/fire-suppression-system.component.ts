...
@Component({
  ...
  styleUrls: ["./fire-suppression-system.component.scss"]
})
export class FireSuppressionSystemComponent implements OnInit {
  ...
  initChartOne() {
    ...
    chart.data = [
      {
        kpj: "FIRESUPPRESSIONIPOH3",
        oxygen: 23.5,
        co2: 18.1
      },
      {
        kpj: "FIRESUPPRESSIONKAJANG1",
        oxygen: 26.2,
        co2: 22.8
      },
      {
        kpj: "FIRESUPPRESSIONSEREMBAN5",
        oxygen: 30.1,
        co2: 23.9
      },
      {
        kpj: "FIRESUPPRESSIONRAWANG10",
        oxygen: 29.5,
        co2: 25.1
      },
      {
        kpj: "FIRESUPPRESSIONPENANG3",
        oxygen: 24.6,
        co2: 25
      }
    ];
    ...
    categoryAxis.dataFields.category = "kpj";
    ...
    function createSeries(field, name) {
      ...
      series.dataFields.categoryY = "kpj";
      series.name = name;
